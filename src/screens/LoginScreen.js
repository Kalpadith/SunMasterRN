            ...
            <View style={[{ height: SCREEN_HEIGHT }]}>
                <View style={[Theme.container, Theme.w100, Theme.h100]}>
                    <View style={[Theme.w98, Theme.h7, Theme.justAlign]}>
                        <Text style={[Theme.fWhite, Theme.f20]}> Login </Text>
                    </View>
                    <View style={[Theme.w98, Theme.h90, Theme.border1_5, Theme.bgBlack, Theme.justAlign]}>
                        
                        
                    <View>
                            <Text style={[Theme.txtbordercontainer, Theme.fGray, Theme.justAlign]}>
